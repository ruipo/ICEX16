...
path = '/Users/Rui/Documents/Graduate/Research/ICEX:SIMI/ICEX16/icex_spl_sd/alogs/macrura_14_3_2016_____00_23_15_alvtmp/';
...
starttime_str = '2016-03-14 00:23:24';
...
figpath = '/Users/Rui/Documents/Graduate/Research/ICEX:SIMI/ICEX16/icex_spl_sd/03-14-2016/ang_figures/';
...
% 
% subplot(3,3,[1,4,7])
% plot([0 1],ones(2,1)*-depth_interp(1),'k','linewidth',2)
% hold on
% plot(0.5,-depth_interp(1),'p','Markersize',15,'MarkerEdgeColor','black','MarkerFaceColor','Yellow')
% ylim([0 250])
% set(gca,'Ydir','reverse')
% ylabel('Depth (m)')
% set(gca,'fontsize',15)
...
% colormap jet
% hold on
% plot([40 6000],ones(2,1)*datenum(datetimevec(1)),'k','linewidth',2)
% 
% subplot(3,3,[8,9])
% plot(freq,10*log10(psd_mat(1,:)/(1E-6)^2),'b','linewidth',2)
% xlim([40 6000])
% ylim([30 90])
% set(gca,'Xticklabel',[100 1000]) 
% grid on
...
for ii = 1:size(beamform_mat,1)
    ...
    plot(elev(inds),-depth_interp(ii),'bo','linewidth',1.5);
end
    
%% Plotting - depth vs bf

figpath = '/Users/Rui/Documents/Graduate/Research/ICEX:SIMI/ICEX16/icex_spl_sd/03-14-2016/bf_figures/';
...
% 
% figure
% h = pcolor(freq,time_vec,10*log10(psd_mat/(1E-6)^2));
% xlabel('Frequency (Hz)');
% ylabel('Time')
% xlim([40 6000])
% set(h,'Edgecolor','None')
...
% 
% figure
% h = pcolor(10*log10(psd_mat(26:end,:)/(1E-6)^2));
% xlabel('Frequency (Hz)');
% ylabel('Time')
% xlim([40 6000])
% set(h,'Edgecolor','None')
...
% 
% figure
% h = pcolor(timevec_utc,elev,10*log10(abs(beamform_mat.')/1E-12));
...
% 
% figure
% h = pcolor(-depth_interp(1:end-1),elev,10*log10(abs(beamform_mat(1:end-1,:).')/1E-12));
% ylabel('Elevation (Deg.)');
% xlabel('Depth')
% ylim([-90 90])
% set(h,'Edgecolor','None')
